...
class CarRacingSim(base.CarRacingSim):
    ...
    def animate(self, filename="untitled", ani_time = 400, lap_number=None, racing_game = False, mpc_cbf = False):
        ...
        sim_time = int(round((self.vehicles["ego"].times[lap_number-1][-1]-self.vehicles["ego"].times[lap_number-1][0])/self.vehicles["ego"].timestep))+1
