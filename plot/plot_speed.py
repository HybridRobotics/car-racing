...
plt.plot(traj_xcurv_1[0:-1,4], traj_xglob_1[0:-1,0], linewidth = 8)
plt.plot(traj_xcurv[0:-1,4], traj_xglob[0:-1,0], linewidth = 8)
# mark overtake zone
tmp1 = np.zeros((2,2))
tmp1[0,0] = 17.44
tmp1[0,1] = 17.44
...
plt.tight_layout()
plt.savefig("media/figures/speed.png",format="png",dpi=1000,pad_inches=0)
plt.show()